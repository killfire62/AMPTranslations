...
The goal is to facilitate the integration of translations into your AMP projects, thereby enabling a localized user experience for an international audience. While AMP supports internationalization, obtaining complete and up-to-date translation files for all features can be a challenge. This repository centralizes and maintains these files for you.
